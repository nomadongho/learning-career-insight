...
function toDate(dateValue) {
  return resultHistoryStore.toDate(dateValue);
}
...
function loadSavedResultHistory() {
  return resultHistoryStore.load();
}
...
function appendResultToHistory(snapshot) {
  savedResultHistory = [snapshot, ...savedResultHistory].slice(0, resultHistoryStore.limit);
